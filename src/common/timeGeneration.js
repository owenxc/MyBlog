...
TimeGeneration.prototype = {
    ...
    getTime: function () {
        var time = new Date();
        return [parseInt(time.getHours() / 10).toString(),
            parseInt(time.getHours() % 10).toString(),
            parseInt(time.getMinutes() / 10).toString(),
            parseInt(time.getMinutes() % 10).toString(),
            parseInt(time.getSeconds() / 10).toString(),
            parseInt(time.getSeconds() % 10).toString()]
    },
